...
`,Ai=class extends lit_element_r{constructor(){super(),((e,t,o)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,o)})(this,$i,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const o=new CustomEvent(e,gi({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(o),o}static define(e,t=this,o={}){const n=customElements.get(e);if(!n){try{customElements.define(e,t,o)}catch(n){customElements.define(e,class extends t{},o)}return}let r=" (unknown version)",s=r;"version"in t&&t.version&&(r=" v"+t.version),"version"in n&&n.version&&(s=" v"+n.version)}attributeChangedCallback(e,t,o){var n,r,s;bi(n=this,r=$i,"read from private field"),(s?s.call(n):r.get(n))||(this.constructor.elementProperties.forEach(((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])})),((e,t,o,n)=>{bi(e,t,"write to private field"),n?n.call(e,o):t.set(e,o)})(this,$i,!0)),super.attributeChangedCallback(e,t,o)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach(((t,o)=>{e.has(o)&&null==this[o]&&(this[o]=t)}))}};$i=new WeakMap,Ai.version="2.17.1",Ai.dependencies={},fi([Vt()],Ai.prototype,"dir",2),fi([Vt()],Ai.prototype,"lang",2);const Ri=Math.min,Ti=Math.max,Di=Math.round,Ei=Math.floor,Li=e=>({x:e,y:e}),Oi={left:"right",right:"left",bottom:"top",top:"bottom"},Bi={start:"end",end:"start"};function Fi(e,t,o){return Ti(e,Ri(t,o))}function Mi(e,t){return"function"==typeof e?e(t):e}function Ii(e){return e.split("-")[0]}function zi(e){return e.split("-")[1]}function Wi(e){return"x"===e?"y":"x"}function Ui(e){return"y"===e?"height":"width"}function Hi(e){return["top","bottom"].includes(Ii(e))?"y":"x"}function Ni(e){return Wi(Hi(e))}function Vi(e){return e.replace(/start|end/g,(e=>Bi[e]))}function ji(e){return e.replace(/left|right|bottom|top/g,(e=>Oi[e]))}function Gi(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function qi(e){const{x:t,y:o,width:n,height:r}=e;return{width:n,height:r,top:o,left:t,right:t+n,bottom:o+r,x:t,y:o}}function Qi(e,t,o){let{reference:n,floating:r}=e;const s=Hi(t),a=Ni(t),l=Ui(a),c=Ii(t),h="y"===s,d=n.x+n.width/2-r.width/2,p=n.y+n.height/2-r.height/2,u=n[l]/2-r[l]/2;let g;switch(c){case"top":g={x:d,y:n.y-r.height};break;case"bottom":g={x:d,y:n.y+n.height};break;case"right":g={x:n.x+n.width,y:p};break;case"left":g={x:n.x-r.width,y:p};break;default:g={x:n.x,y:n.y}}switch(zi(t)){case"start":g[a]-=u*(o&&h?-1:1);break;case"end":g[a]+=u*(o&&h?-1:1)}return g}async function Ji(e,t){var o;void 0===t&&(t={});const{x:n,y:r,platform:s,rects:a,elements:l,strategy:c}=e,{boundary:h="clippingAncestors",rootBoundary:d="viewport",elementContext:p="floating",altBoundary:u=!1,padding:g=0}=Mi(t,e),m=Gi(g),f=l[u?"floating"===p?"reference":"floating":p],v=qi(await s.getClippingRect({element:null==(o=await(null==s.isElement?void 0:s.isElement(f)))||o?f:f.contextElement||await(null==s.getDocumentElement?void 0:s.getDocumentElement(l.floating)),boundary:h,rootBoundary:d,strategy:c})),y="floating"===p?{x:n,y:r,width:a.floating.width,height:a.floating.height}:a.reference,w=await(null==s.getOffsetParent?void 0:s.getOffsetParent(l.floating)),x=await(null==s.isElement?void 0:s.isElement(w))&&await(null==s.getScale?void 0:s.getScale(w))||{x:1,y:1},_=qi(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:y,offsetParent:w,strategy:c}):y);return{top:(v.top-_.top+m.top)/x.y,bottom:(_.bottom-v.bottom+m.bottom)/x.y,left:(v.left-_.left+m.left)/x.x,right:(_.right-v.right+m.right)/x.x}}function Yi(){return"undefined"!=typeof window}function Ki(e){return eo(e)?(e.nodeName||"").toLowerCase():"#document"}function Zi(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function Xi(e){var t;return null==(t=(eo(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function eo(e){return!!Yi()&&(e instanceof Node||e instanceof Zi(e).Node)}function to(e){return!!Yi()&&(e instanceof Element||e instanceof Zi(e).Element)}function io(e){return!!Yi()&&(e instanceof HTMLElement||e instanceof Zi(e).HTMLElement)}function oo(e){return!(!Yi()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof Zi(e).ShadowRoot)}function no(e){const{overflow:t,overflowX:o,overflowY:n,display:r}=ho(e);return/auto|scroll|overlay|hidden|clip/.test(t+n+o)&&!["inline","contents"].includes(r)}function ro(e){return["table","td","th"].includes(Ki(e))}function so(e){return[":popover-open",":modal"].some((t=>{try{return e.matches(t)}catch(e){return!1}}))}function ao(e){const t=lo(),o=to(e)?ho(e):e;return"none"!==o.transform||"none"!==o.perspective||!!o.containerType&&"normal"!==o.containerType||!t&&!!o.backdropFilter&&"none"!==o.backdropFilter||!t&&!!o.filter&&"none"!==o.filter||["transform","perspective","filter"].some((e=>(o.willChange||"").includes(e)))||["paint","layout","strict","content"].some((e=>(o.contain||"").includes(e)))}function lo(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function co(e){return["html","body","#document"].includes(Ki(e))}function ho(e){return Zi(e).getComputedStyle(e)}function po(e){return to(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function uo(e){if("html"===Ki(e))return e;const t=e.assignedSlot||e.parentNode||oo(e)&&e.host||Xi(e);return oo(t)?t.host:t}function go(e){const t=uo(e);return co(t)?e.ownerDocument?e.ownerDocument.body:e.body:io(t)&&no(t)?t:go(t)}function mo(e,t,o){var n;void 0===t&&(t=[]),void 0===o&&(o=!0);const r=go(e),s=r===(null==(n=e.ownerDocument)?void 0:n.body),a=Zi(r);if(s){const e=fo(a);return t.concat(a,a.visualViewport||[],no(r)?r:[],e&&o?mo(e):[])}return t.concat(r,mo(r,[],o))}function fo(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function bo(e){const t=ho(e);let o=parseFloat(t.width)||0,n=parseFloat(t.height)||0;const r=io(e),s=r?e.offsetWidth:o,a=r?e.offsetHeight:n,l=Di(o)!==s||Di(n)!==a;return l&&(o=s,n=a),{width:o,height:n,$:l}}function vo(e){return to(e)?e:e.contextElement}function yo(e){const t=vo(e);if(!io(t))return Li(1);const o=t.getBoundingClientRect(),{width:n,height:r,$:s}=bo(t);let a=(s?Di(o.width):o.width)/n,l=(s?Di(o.height):o.height)/r;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}const wo=Li(0);function xo(e){const t=Zi(e);return lo()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:wo}function ko(e,t,o,n){void 0===t&&(t=!1),void 0===o&&(o=!1);const r=e.getBoundingClientRect(),s=vo(e);let a=Li(1);t&&(n?to(n)&&(a=yo(n)):a=yo(e));const l=function(e,t,o){return void 0===t&&(t=!1),!(!o||t&&o!==Zi(e))&&t}(s,o,n)?xo(s):Li(0);let c=(r.left+l.x)/a.x,h=(r.top+l.y)/a.y,d=r.width/a.x,p=r.height/a.y;if(s){const e=Zi(s),t=n&&to(n)?Zi(n):n;let o=e,r=fo(o);for(;r&&n&&t!==o;){const e=yo(r),t=r.getBoundingClientRect(),n=ho(r),s=t.left+(r.clientLeft+parseFloat(n.paddingLeft))*e.x,a=t.top+(r.clientTop+parseFloat(n.paddingTop))*e.y;c*=e.x,h*=e.y,d*=e.x,p*=e.y,c+=s,h+=a,o=Zi(r),r=fo(o)}}return qi({width:d,height:p,x:c,y:h})}function _o(e,t){const o=po(e).scrollLeft;return t?t.left+o:ko(Xi(e)).left+o}function $o(e,t,o){void 0===o&&(o=!1);const n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-(o?0:_o(e,n)),y:n.top+t.scrollTop}}function Co(e,t,o){let n;if("viewport"===t)n=function(e,t){const o=Zi(e),n=Xi(e),r=o.visualViewport;let s=n.clientWidth,a=n.clientHeight,l=0,c=0;if(r){s=r.width,a=r.height;const e=lo();(!e||e&&"fixed"===t)&&(l=r.offsetLeft,c=r.offsetTop)}return{width:s,height:a,x:l,y:c}}(e,o);else if("document"===t)n=function(e){const t=Xi(e),o=po(e),n=e.ownerDocument.body,r=Ti(t.scrollWidth,t.clientWidth,n.scrollWidth,n.clientWidth),s=Ti(t.scrollHeight,t.clientHeight,n.scrollHeight,n.clientHeight);let a=-o.scrollLeft+_o(e);const l=-o.scrollTop;return"rtl"===ho(n).direction&&(a+=Ti(t.clientWidth,n.clientWidth)-r),{width:r,height:s,x:a,y:l}}(Xi(e));else if(to(t))n=function(e,t){const o=ko(e,!0,"fixed"===t),n=o.top+e.clientTop,r=o.left+e.clientLeft,s=io(e)?yo(e):Li(1);return{width:e.clientWidth*s.x,height:e.clientHeight*s.y,x:r*s.x,y:n*s.y}}(t,o);else{const o=xo(e);n={x:t.x-o.x,y:t.y-o.y,width:t.width,height:t.height}}return qi(n)}function Po(e,t){const o=uo(e);return!(o===t||!to(o)||co(o))&&("fixed"===ho(o).position||Po(o,t))}function So(e,t,o){const n=io(t),r=Xi(t),s="fixed"===o,a=ko(e,!0,s,t);let l={scrollLeft:0,scrollTop:0};const c=Li(0);if(n||!n&&!s)if(("body"!==Ki(t)||no(r))&&(l=po(t)),n){const e=ko(t,!0,s,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else r&&(c.x=_o(r));const h=!r||n||s?Li(0):$o(r,l);return{x:a.left+l.scrollLeft-c.x-h.x,y:a.top+l.scrollTop-c.y-h.y,width:a.width,height:a.height}}function Ao(e){return"static"===ho(e).position}function Ro(e,t){if(!io(e)||"fixed"===ho(e).position)return null;if(t)return t(e);let o=e.offsetParent;return Xi(e)===o&&(o=o.ownerDocument.body),o}function To(e,t){const o=Zi(e);if(so(e))return o;if(!io(e)){let t=uo(e);for(;t&&!co(t);){if(to(t)&&!Ao(t))return t;t=uo(t)}return o}let n=Ro(e,t);for(;n&&ro(n)&&Ao(n);)n=Ro(n,t);return n&&co(n)&&Ao(n)&&!ao(n)?o:n||function(e){let t=uo(e);for(;io(t)&&!co(t);){if(ao(t))return t;if(so(t))return null;t=uo(t)}return null}(e)||o}const Do={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:o,offsetParent:n,strategy:r}=e;const s="fixed"===r,a=Xi(n),l=!!t&&so(t.floating);if(n===a||l&&s)return o;let c={scrollLeft:0,scrollTop:0},h=Li(1);const d=Li(0),p=io(n);if((p||!p&&!s)&&(("body"!==Ki(n)||no(a))&&(c=po(n)),io(n))){const e=ko(n);h=yo(n),d.x=e.x+n.clientLeft,d.y=e.y+n.clientTop}const u=!a||p||s?Li(0):$o(a,c,!0);return{width:o.width*h.x,height:o.height*h.y,x:o.x*h.x-c.scrollLeft*h.x+d.x+u.x,y:o.y*h.y-c.scrollTop*h.y+d.y+u.y}},getDocumentElement:Xi,getClippingRect:function(e){let{element:t,boundary:o,rootBoundary:n,strategy:r}=e;const s=[..."clippingAncestors"===o?so(t)?[]:function(e,t){const o=t.get(e);if(o)return o;let n=mo(e,[],!1).filter((e=>to(e)&&"body"!==Ki(e))),r=null;const s="fixed"===ho(e).position;let a=s?uo(e):e;for(;to(a)&&!co(a);){const t=ho(a),o=ao(a);o||"fixed"!==t.position||(r=null),(s?!o&&!r:!o&&"static"===t.position&&r&&["absolute","fixed"].includes(r.position)||no(a)&&!o&&Po(e,a))?n=n.filter((e=>e!==a)):r=t,a=uo(a)}return t.set(e,n),n}(t,this._c):[].concat(o),n],a=s[0],l=s.reduce(((e,o)=>{const n=Co(t,o,r);return e.top=Ti(n.top,e.top),e.right=Ri(n.right,e.right),e.bottom=Ri(n.bottom,e.bottom),e.left=Ti(n.left,e.left),e}),Co(t,a,r));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:To,getElementRects:async function(e){const t=this.getOffsetParent||To,o=this.getDimensions,n=await o(e.floating);return{reference:So(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:o}=bo(e);return{width:t,height:o}},getScale:yo,isElement:to,isRTL:function(e){return"rtl"===ho(e).direction}};function Eo(e,t,o,n){void 0===n&&(n={});const{ancestorScroll:r=!0,ancestorResize:s=!0,elementResize:a="function"==typeof ResizeObserver,layoutShift:l="function"==typeof IntersectionObserver,animationFrame:c=!1}=n,h=vo(e),d=r||s?[...h?mo(h):[],...mo(t)]:[];d.forEach((e=>{r&&e.addEventListener("scroll",o,{passive:!0}),s&&e.addEventListener("resize",o)}));const p=h&&l?function(e,t){let o,n=null;const r=Xi(e);function s(){var e;clearTimeout(o),null==(e=n)||e.disconnect(),n=null}return function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),s();const{left:h,top:d,width:p,height:u}=e.getBoundingClientRect();if(l||t(),!p||!u)return;const g={rootMargin:-Ei(d)+"px "+-Ei(r.clientWidth-(h+p))+"px "+-Ei(r.clientHeight-(d+u))+"px "+-Ei(h)+"px",threshold:Ti(0,Ri(1,c))||1};let m=!0;function f(e){const t=e[0].intersectionRatio;if(t!==c){if(!m)return a();t?a(!1,t):o=setTimeout((()=>{a(!1,1e-7)}),1e3)}m=!1}try{n=new IntersectionObserver(f,{...g,root:r.ownerDocument})}catch(e){n=new IntersectionObserver(f,g)}n.observe(e)}(!0),s}(h,o):null;let u,g=-1,m=null;a&&(m=new ResizeObserver((e=>{let[n]=e;n&&n.target===h&&m&&(m.unobserve(t),cancelAnimationFrame(g),g=requestAnimationFrame((()=>{var e;null==(e=m)||e.observe(t)}))),o()})),h&&!c&&m.observe(h),m.observe(t));let f=c?ko(e):null;return c&&function t(){const n=ko(e);!f||n.x===f.x&&n.y===f.y&&n.width===f.width&&n.height===f.height||o();f=n,u=requestAnimationFrame(t)}(),o(),()=>{var e;d.forEach((e=>{r&&e.removeEventListener("scroll",o),s&&e.removeEventListener("resize",o)})),null==p||p(),null==(e=m)||e.disconnect(),m=null,c&&cancelAnimationFrame(u)}}const Lo=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var o,n;const{x:r,y:s,placement:a,middlewareData:l}=t,c=await async function(e,t){const{placement:o,platform:n,elements:r}=e,s=await(null==n.isRTL?void 0:n.isRTL(r.floating)),a=Ii(o),l=zi(o),c="y"===Hi(o),h=["left","top"].includes(a)?-1:1,d=s&&c?-1:1,p=Mi(t,e);let{mainAxis:u,crossAxis:g,alignmentAxis:m}="number"==typeof p?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return l&&"number"==typeof m&&(g="end"===l?-1*m:m),c?{x:g*d,y:u*h}:{x:u*h,y:g*d}}(t,e);return a===(null==(o=l.offset)?void 0:o.placement)&&null!=(n=l.arrow)&&n.alignmentOffset?{}:{x:r+c.x,y:s+c.y,data:{...c,placement:a}}}}},Oo=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:o,y:n,placement:r}=t,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:o}=e;return{x:t,y:o}}},...c}=Mi(e,t),h={x:o,y:n},d=await Ji(t,c),p=Hi(Ii(r)),u=Wi(p);let g=h[u],m=h[p];if(s){const e="y"===u?"bottom":"right";g=Fi(g+d["y"===u?"top":"left"],g,g-d[e])}if(a){const e="y"===p?"bottom":"right";m=Fi(m+d["y"===p?"top":"left"],m,m-d[e])}const f=l.fn({...t,[u]:g,[p]:m});return{...f,data:{x:f.x-o,y:f.y-n,enabled:{[u]:s,[p]:a}}}}}},Bo=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var o,n;const{placement:r,middlewareData:s,rects:a,initialPlacement:l,platform:c,elements:h}=t,{mainAxis:d=!0,crossAxis:p=!0,fallbackPlacements:u,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:m="none",flipAlignment:f=!0,...v}=Mi(e,t);if(null!=(o=s.arrow)&&o.alignmentOffset)return{};const y=Ii(r),w=Hi(l),x=Ii(l)===l,_=await(null==c.isRTL?void 0:c.isRTL(h.floating)),$=u||(x||!f?[ji(l)]:function(e){const t=ji(e);return[Vi(e),t,Vi(t)]}(l)),C="none"!==m;!u&&C&&$.push(...function(e,t,o,n){const r=zi(e);let s=function(e,t,o){const n=["left","right"],r=["right","left"],s=["top","bottom"],a=["bottom","top"];switch(e){case"top":case"bottom":return o?t?r:n:t?n:r;case"left":case"right":return t?s:a;default:return[]}}(Ii(e),"start"===o,n);return r&&(s=s.map((e=>e+"-"+r)),t&&(s=s.concat(s.map(Vi)))),s}(l,f,m,_));const P=[l,...$],S=await Ji(t,v),A=[];let T=(null==(n=s.flip)?void 0:n.overflows)||[];if(d&&A.push(S[y]),p){const e=function(e,t,o){void 0===o&&(o=!1);const n=zi(e),r=Ni(e),s=Ui(r);let a="x"===r?n===(o?"end":"start")?"right":"left":"start"===n?"bottom":"top";return t.reference[s]>t.floating[s]&&(a=ji(a)),[a,ji(a)]}(r,a,_);A.push(S[e[0]],S[e[1]])}if(T=[...T,{placement:r,overflows:A}],!A.every((e=>e<=0))){var D,E;const e=((null==(D=s.flip)?void 0:D.index)||0)+1,t=P[e];if(t)return{data:{index:e,overflows:T},reset:{placement:t}};let o=null==(E=T.filter((e=>e.overflows[0]<=0)).sort(((e,t)=>e.overflows[1]-t.overflows[1]))[0])?void 0:E.placement;if(!o)switch(g){case"bestFit":{var O;const e=null==(O=T.filter((e=>{if(C){const t=Hi(e.placement);return t===w||"y"===t}return!0})).map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:O[0];e&&(o=e);break}case"initialPlacement":o=l}if(r!==o)return{reset:{placement:o}}}return{}}}},Fo=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var o,n;const{placement:r,rects:s,platform:a,elements:l}=t,{apply:c=()=>{},...h}=Mi(e,t),d=await Ji(t,h),p=Ii(r),u=zi(r),g="y"===Hi(r),{width:m,height:f}=s.floating;let v,y;"top"===p||"bottom"===p?(v=p,y=u===(await(null==a.isRTL?void 0:a.isRTL(l.floating))?"start":"end")?"left":"right"):(y=p,v="end"===u?"top":"bottom");const w=f-d.top-d.bottom,x=m-d.left-d.right,_=Ri(f-d[v],w),$=Ri(m-d[y],x),C=!t.middlewareData.shift;let P=_,S=$;if(null!=(o=t.middlewareData.shift)&&o.enabled.x&&(S=x),null!=(n=t.middlewareData.shift)&&n.enabled.y&&(P=w),C&&!u){const e=Ti(d.left,0),t=Ti(d.right,0),o=Ti(d.top,0),n=Ti(d.bottom,0);g?S=m-2*(0!==e||0!==t?e+t:Ti(d.left,d.right)):P=f-2*(0!==o||0!==n?o+n:Ti(d.top,d.bottom))}await c({...t,availableWidth:S,availableHeight:P});const A=await a.getDimensions(l.floating);return m!==A.width||f!==A.height?{reset:{rects:!0}}:{}}}},Mo=e=>({name:"arrow",options:e,async fn(t){const{x:o,y:n,placement:r,rects:s,platform:a,elements:l,middlewareData:c}=t,{element:h,padding:d=0}=Mi(e,t)||{};if(null==h)return{};const p=Gi(d),u={x:o,y:n},g=Ni(r),m=Ui(g),f=await a.getDimensions(h),v="y"===g,y=v?"top":"left",w=v?"bottom":"right",x=v?"clientHeight":"clientWidth",_=s.reference[m]+s.reference[g]-u[g]-s.floating[m],$=u[g]-s.reference[g],C=await(null==a.getOffsetParent?void 0:a.getOffsetParent(h));let P=C?C[x]:0;P&&await(null==a.isElement?void 0:a.isElement(C))||(P=l.floating[x]||s.floating[m]);const S=_/2-$/2,A=P/2-f[m]/2-1,T=Ri(p[y],A),D=Ri(p[w],A),E=T,O=P-f[m]-D,B=P/2-f[m]/2+S,F=Fi(E,B,O),W=!c.arrow&&null!=zi(r)&&B!==F&&s.reference[m]/2-(B<E?T:D)-f[m]/2<0,U=W?B<E?B-E:B-O:0;return{[g]:u[g]+U,data:{[g]:F,centerOffset:B-F-U,...W&&{alignmentOffset:U}},reset:W}}}),Io=(e,t,o)=>{const n=new Map,r={platform:Do,...o},s={...r.platform,_c:n};return(async(e,t,o)=>{const{placement:n="bottom",strategy:r="absolute",middleware:s=[],platform:a}=o,l=s.filter(Boolean),c=await(null==a.isRTL?void 0:a.isRTL(t));let h=await a.getElementRects({reference:e,floating:t,strategy:r}),{x:d,y:p}=Qi(h,n,c),u=n,g={},m=0;for(let o=0;o<l.length;o++){const{name:s,fn:f}=l[o],{x:v,y,data:w,reset:x}=await f({x:d,y:p,initialPlacement:n,placement:u,strategy:r,middlewareData:g,rects:h,platform:a,elements:{reference:e,floating:t}});d=null!=v?v:d,p=null!=y?y:p,g={...g,[s]:{...g[s],...w}},x&&m<=50&&(m++,"object"==typeof x&&(x.placement&&(u=x.placement),x.rects&&(h=!0===x.rects?await a.getElementRects({reference:e,floating:t,strategy:r}):x.rects),({x:d,y:p}=Qi(h,u,c))),o=-1)}return{x:d,y:p,placement:u,strategy:r,middlewareData:g}})(e,t,{...r,platform:s})},zo=1;class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Wo=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends directive_i{constructor(e){if(super(e),e.type!==zo||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const o=e.element.classList;for(const e of this.st)e in t||(o.remove(e),this.st.delete(e));for(const e in t){const n=!!t[e];n===this.st.has(e)||this.nt?.has(e)||(n?(o.add(e),this.st.add(e)):(o.remove(e),this.st.delete(e)))}return Et}});function Uo(e){return No(e)}function Ho(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function No(e){for(let t=e;t;t=Ho(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=Ho(e);t;t=Ho(t)){if(!(t instanceof Element))continue;const e=getComputedStyle(t);if("contents"!==e.display){if("static"!==e.position||"none"!==e.filter)return t;if("BODY"===t.tagName)return t}}return null}var Vo=class extends Ai{constructor(){super(...arguments),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect();let o=0,n=0,r=0,s=0,a=0,l=0,c=0,h=0;this.placement.includes("top")||this.placement.includes("bottom")?e.top<t.top?(o=e.left,n=e.bottom,r=e.right,s=e.bottom,a=t.left,l=t.top,c=t.right,h=t.top):(o=t.left,n=t.bottom,r=t.right,s=t.bottom,a=e.left,l=e.top,c=e.right,h=e.top):e.left<t.left?(o=e.right,n=e.top,r=t.left,s=t.top,a=e.right,l=e.bottom,c=t.left,h=t.bottom):(o=t.right,n=t.top,r=e.left,s=e.top,a=t.right,l=t.bottom,c=e.left,h=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${n}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${s}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${h}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||function(e){return null!==e&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e instanceof Element)}(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&(this.cleanup=Eo(this.anchorEl,this.popup,(()=>{this.reposition()})))}async stop(){return new Promise((e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame((()=>e()))):e()}))}reposition(){if(!this.active||!this.anchorEl)return;const e=[Lo({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Fo({apply:({rects:e})=>{const t="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=o?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(Bo({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(Oo({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Fo({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(Mo({element:this.arrowEl,padding:this.arrowPadding}));const t="absolute"===this.strategy?e=>Do.getOffsetParent(e,Uo):Do.getOffsetParent;Io(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:mi(gi({},Do),{getOffsetParent:t})}).then((({x:e,y:t,middlewareData:o,placement:n})=>{const r=this.matches(":dir(rtl)"),s={top:"bottom",right:"left",bottom:"top",left:"right"}[n.split("-")[0]];if(this.setAttribute("data-current-placement",n),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){const e=o.arrow.x,t=o.arrow.y;let n="",a="",l="",c="";if("start"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";n="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",a=r?o:"",c=r?"":o}else if("end"===this.arrowPlacement){const o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";a=r?"":o,c=r?o:"",l="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",n="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof e?`${e}px`:"",n="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:n,right:a,bottom:l,left:c,[s]:"calc(var(--arrow-size-diagonal) * -1)"})}})),requestAnimationFrame((()=>this.updateHoverBridge())),this.emit("sl-reposition")}render(){return Dt`
    ...
    `}};function jo(e,t){return new Promise((o=>{e.addEventListener(t,(function n(r){r.target===e&&(e.removeEventListener(t,n),o())}))}))}function Go(e,t,o){return new Promise((n=>{if((null==o?void 0:o.duration)===1/0)throw new Error("Promise-based animations must be finite.");const r=e.animate(t,mi(gi({},o),{duration:Qo()?0:o.duration}));r.addEventListener("cancel",n,{once:!0}),r.addEventListener("finish",n,{once:!0})}))}function qo(e){return(e=e.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?1e3*parseFloat(e):parseFloat(e)}function Qo(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Jo(e){return Promise.all(e.getAnimations().map((e=>new Promise((t=>{e.cancel(),requestAnimationFrame(t)})))))}Vo.styles=[Si,Pi],fi([Gt(".popup")],Vo.prototype,"popup",2),fi([Gt(".popup__arrow")],Vo.prototype,"arrowEl",2),fi([Vt()],Vo.prototype,"anchor",2),fi([Vt({type:Boolean,reflect:!0})],Vo.prototype,"active",2),fi([Vt({reflect:!0})],Vo.prototype,"placement",2),fi([Vt({reflect:!0})],Vo.prototype,"strategy",2),fi([Vt({type:Number})],Vo.prototype,"distance",2),fi([Vt({type:Number})],Vo.prototype,"skidding",2),fi([Vt({type:Boolean})],Vo.prototype,"arrow",2),fi([Vt({attribute:"arrow-placement"})],Vo.prototype,"arrowPlacement",2),fi([Vt({attribute:"arrow-padding",type:Number})],Vo.prototype,"arrowPadding",2),fi([Vt({type:Boolean})],Vo.prototype,"flip",2),fi([Vt({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map((e=>e.trim())).filter((e=>""!==e)),toAttribute:e=>e.join(" ")}})],Vo.prototype,"flipFallbackPlacements",2),fi([Vt({attribute:"flip-fallback-strategy"})],Vo.prototype,"flipFallbackStrategy",2),fi([Vt({type:Object})],Vo.prototype,"flipBoundary",2),fi([Vt({attribute:"flip-padding",type:Number})],Vo.prototype,"flipPadding",2),fi([Vt({type:Boolean})],Vo.prototype,"shift",2),fi([Vt({type:Object})],Vo.prototype,"shiftBoundary",2),fi([Vt({attribute:"shift-padding",type:Number})],Vo.prototype,"shiftPadding",2),fi([Vt({attribute:"auto-size"})],Vo.prototype,"autoSize",2),fi([Vt()],Vo.prototype,"sync",2),fi([Vt({type:Object})],Vo.prototype,"autoSizeBoundary",2),fi([Vt({attribute:"auto-size-padding",type:Number})],Vo.prototype,"autoSizePadding",2),fi([Vt({attribute:"hover-bridge",type:Boolean})],Vo.prototype,"hoverBridge",2);const Yo=new Set,Ko=new Map;let Zo,Xo="ltr",en="en";const tn="undefined"!=typeof MutationObserver&&"undefined"!=typeof document&&void 0!==document.documentElement;if(tn){const e=new MutationObserver(nn);Xo=document.documentElement.dir||"ltr",en=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function on(...e){e.map((e=>{const t=e.$code.toLowerCase();Ko.has(t)?Ko.set(t,Object.assign(Object.assign({},Ko.get(t)),e)):Ko.set(t,e),Zo||(Zo=e)})),nn()}function nn(){tn&&(Xo=document.documentElement.dir||"ltr",en=document.documentElement.lang||navigator.language),[...Yo.keys()].map((e=>{"function"==typeof e.requestUpdate&&e.requestUpdate()}))}class LocalizeController{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){Yo.add(this.host)}hostDisconnected(){Yo.delete(this.host)}dir(){return`${this.host.dir||Xo}`.toLowerCase()}lang(){return`${this.host.lang||en}`.toLowerCase()}getTranslationData(e){var t,o;const n=new Intl.Locale(e.replace(/_/g,"-")),r=null==n?void 0:n.language.toLowerCase(),s=null!==(o=null===(t=null==n?void 0:n.region)||void 0===t?void 0:t.toLowerCase())&&void 0!==o?o:"";return{locale:n,language:r,region:s,primary:Ko.get(`${r}-${s}`),secondary:Ko.get(r)}}exists(e,t){var o;const{primary:n,secondary:r}=this.getTranslationData(null!==(o=t.lang)&&void 0!==o?o:this.lang());return t=Object.assign({includeFallback:!1},t),!!(n&&n[e]||r&&r[e]||t.includeFallback&&Zo&&Zo[e])}term(e,...t){const{primary:o,secondary:n}=this.getTranslationData(this.lang());let r;if(o&&o[e])r=o[e];else if(n&&n[e])r=n[e];else{if(!Zo||!Zo[e])return String(e);r=Zo[e]}return"function"==typeof r?r(...t):r}date(e,t){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),t).format(e)}number(e,t){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),t).format(e)}relativeTime(e,t,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(e,t)}}var rn={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>0===e?"No options selected":1===e?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};on(rn);var sn=rn,an=class extends LocalizeController{};function ln(e,t){const o=gi({waitUntilFirstUpdate:!1},t);return(t,n)=>{const{update:r}=t,s=Array.isArray(e)?e:[e];t.update=function(e){s.forEach((t=>{const r=t;if(e.has(r)){const t=e.get(r),s=this[r];t!==s&&(o.waitUntilFirstUpdate&&!this.hasUpdated||this[n](t,s))}})),r.call(this,e)}}}on(sn);var cn=class extends Ai{constructor(){super(),this.localize=new an(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=qo(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.show()),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=qo(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.hide()),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(e=this.closeWatcher)||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await Jo(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:t,options:o}=_i(this,"tooltip.show",{dir:this.localize.dir()});await Go(this.popup.popup,t,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await Jo(this.body);const{keyframes:e,options:o}=_i(this,"tooltip.hide",{dir:this.localize.dir()});await Go(this.popup.popup,e,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,jo(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,jo(this,"sl-after-hide")}render(){return Dt`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};cn.styles=[Si,Ci],cn.dependencies={"sl-popup":Vo},fi([Gt("slot:not([name])")],cn.prototype,"defaultSlot",2),fi([Gt(".tooltip__body")],cn.prototype,"body",2),fi([Gt("sl-popup")],cn.prototype,"popup",2),fi([Vt()],cn.prototype,"content",2),fi([Vt()],cn.prototype,"placement",2),fi([Vt({type:Boolean,reflect:!0})],cn.prototype,"disabled",2),fi([Vt({type:Number})],cn.prototype,"distance",2),fi([Vt({type:Boolean,reflect:!0})],cn.prototype,"open",2),fi([Vt({type:Number})],cn.prototype,"skidding",2),fi([Vt()],cn.prototype,"trigger",2),fi([Vt({type:Boolean})],cn.prototype,"hoist",2),fi([ln("open",{waitUntilFirstUpdate:!0})],cn.prototype,"handleOpenChange",1),fi([ln(["content","distance","hoist","placement","skidding"])],cn.prototype,"handleOptionsChange",1),fi([ln("disabled")],cn.prototype,"handleDisabledChange",1),ki("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),ki("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});cn.define("sl-tooltip");var hn=Object.defineProperty,dn=Object.getOwnPropertyDescriptor,pn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?dn(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&hn(t,o,s),s};ki("tooltip.show",null),ki("tooltip.hide",null);let un=class extends lit_element_r{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver((e=>{for(const t of e)if("attributes"===t.type&&"data-current-placement"===t.attributeName){const e=t.target.getAttribute("data-current-placement");e?this.setAttribute("data-current-placement",e):this.removeAttribute("data-current-placement")}}));const e=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;this.observer.observe(e,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect()}render(){return Dt`<sl-tooltip
			.placement=${this.placement}
	...
	`,pn([Vt()],un.prototype,"content",2),pn([Vt({reflect:!0})],un.prototype,"placement",2),pn([Vt({type:Boolean})],un.prototype,"disabled",2),pn([Vt({type:Number})],un.prototype,"distance",2),pn([Vt({type:Boolean})],un.prototype,"hoist",2),un=pn([Ut("gl-tooltip")],un);var gn=Object.defineProperty,mn=Object.getOwnPropertyDescriptor,fn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?mn(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&gn(t,o,s),s};let bn=class extends lit_element_r{constructor(){super(...arguments),this.disabled=!1,this.full=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return this.tooltip?Dt`<gl-tooltip .content=${this.tooltip}>${this.renderControl()}</gl-tooltip>`:this.querySelectorAll('[slot="tooltip"]').length>0?Dt`<gl-tooltip>
				${this.renderControl()}
			...
			<slot name="prefix"></slot><slot class="label"></slot><slot name="suffix"></slot>
		</button>`}onLinkKeypress(e){" "===e.key&&this.control.click()}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};bn.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},bn.styles=[ni,Qe`
			:host {
...
`;var _n=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,Cn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?$n(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&_n(t,o,s),s};let Pn=class extends lit_element_r{constructor(){super(...arguments),this.type="info"}get hasPromo(){return null!=this.promo}render(){if(!this.promo)return;const e=this.renderPromo(this.promo);return e?"link"===this.type?Dt`<a
				class="link"
		...
		`],Cn([Vt({type:Object})],Pn.prototype,"promo",2),Cn([Vt({reflect:!0,type:String})],Pn.prototype,"type",2),Cn([Vt({reflect:!0,type:Boolean,attribute:"has-promo"})],Pn.prototype,"hasPromo",1),Pn=Cn([Ut("gl-promo")],Pn);var Sn=Object.defineProperty,An=Object.getOwnPropertyDescriptor,Rn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?An(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&Sn(t,o,s),s};let Tn=class extends lit_element_r{firstUpdated(){"alert"===this.appearance&&queueMicrotask((()=>this.button.focus()))}render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":Lt,t=this.state?wn(this.state,"gate"):void 0;switch(this.state){case a.VerificationRequired:return Dt`
					<p class="actions">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Dn(vn.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							class="inline"
							appearance="${e}"
							href="${Dn(vn.PlusValidate,this.source)}"
				...
				`;case a.Community:return Dt`
					<gl-button
						appearance="${e}"
						href="${Dn(vn.PlusStartPreviewTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
						...
						<a href="${Dn(vn.PlusSignUp,this.source)}"
							>start your free ${7}-day Pro trial</a
						>
						or
						<a href="${Dn(vn.PlusLogin,this.source)}" title="Sign In">sign in</a>.
					</p>
				`;case a.ProPreviewExpired:return Dt`
					<gl-button
						appearance="${e}"
						href="${Dn(vn.PlusSignUp,this.source)}"
				...
				`;case a.ProTrialExpired:return Dt` <gl-button
						appearance="${e}"
						href="${Dn(vn.PlusUpgrade,this.source)}"
					...
					<gl-button
						appearance="${e}"
						href="${Dn(vn.PlusReactivateProTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
				...
				`}}renderPromo(e){return Dt`<gl-promo .promo=${e}></gl-promo>`}};function Dn(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}Tn.styles=[kn,Qe`
			:host {
		...
		`],Rn([Gt("gl-button")],Tn.prototype,"button",2),Rn([Vt({type:String})],Tn.prototype,"appearance",2),Rn([Vt()],Tn.prototype,"featureWithArticleIfNeeded",2),Rn([Vt({type:Object})],Tn.prototype,"source",2),Rn([Vt({attribute:!1,type:Number})],Tn.prototype,"state",2),Tn=Rn([Ut("gl-feature-gate-plus-state")],Tn);var En=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,On=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?Ln(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&En(t,o,s),s};let Bn=class extends lit_element_r{render(){if(!this.visible||null!=this.state&&(null!=(e=this.state)&&(e===a.Paid||e===a.ProPreview||e===a.ProTrial)))return void(this.hidden=!0);var e;const t=this.appearance??"editor"===(document.body.getAttribute("data-placement")??"editor")?"alert":"welcome";return this.hidden=!1,Dt`
			<section>
				<slot></slot>
	...
	`,On([Vt({reflect:!0})],Bn.prototype,"appearance",2),On([Vt()],Bn.prototype,"featureWithArticleIfNeeded",2),On([Vt({type:Object})],Bn.prototype,"source",2),On([Vt({attribute:!1,type:Number})],Bn.prototype,"state",2),On([Vt({type:Boolean})],Bn.prototype,"visible",2),Bn=On([Ut("gl-feature-gate")],Bn);Vo.define("sl-popup");const Fn=new WeakMap;function Mn(e,t){return function(o,n,r){let s=Fn.get(o.constructor);null==s&&Fn.set(o.constructor,s=[]),s.push({method:r.value,keys:Array.isArray(e)?e:[e],afterFirstUpdate:t?.afterFirstUpdate??!1})}}class GlElement extends lit_element_r{emit(e,t,o){const n=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,...o,detail:t});return this.dispatchEvent(n),n}update(e){const t=Fn.get(this.constructor);if(null!=t)for(const{keys:o,method:n,afterFirstUpdate:r}of t){if(r&&!this.hasUpdated)continue;const t=o.filter((t=>e.has(t)));t.length&&n.call(this,t)}super.update(e)}}var In=Object.defineProperty,zn=Object.getOwnPropertyDescriptor,Wn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?zn(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&In(t,o,s),s};let Un=class extends GlElement{constructor(){super(),this.placement="bottom",this.disabled=!1,this.distance=8,this.open=!1,this.arrow=!0,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleTriggerBlur=e=>{if(this.open&&this.hasTrigger("focus")){if(e.composedPath().includes(this))return;this.hide()}},this.handleTriggerClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleTriggerFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handlePopupBlur=e=>{e.composedPath().includes(this)||this.hide()},this.handleWebviewBlur=()=>{this.hide()},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);const e=de(getComputedStyle(this).getPropertyValue("--show-delay"));this.hoverTimeout=setTimeout((()=>this.show()),e)}},this.handleMouseOut=e=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);const t=e.composedPath();if(t[t.length-2]===this)return;if(this.hasPopupFocus())return;const o=de(getComputedStyle(this).getPropertyValue("--hide-delay"));this.hoverTimeout=setTimeout((()=>this.hide()),o)}},this.addEventListener("blur",this.handleTriggerBlur,!0),this.addEventListener("focus",this.handleTriggerFocus,!0),this.addEventListener("click",this.handleTriggerClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}get currentPlacement(){return this.popup?.getAttribute("data-current-placement")??this.placement}disconnectedCallback(){this.closeWatcher?.destroy(),document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasPopupFocus(){return this.matches(':has([slot="content"]:focus-within)')}hasTrigger(e){return this.trigger.split(" ").includes(e)}handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("gl-popover-show"),"CloseWatcher"in window?(this.closeWatcher?.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("focusin",this.handlePopupBlur),window.addEventListener("webview-blur",this.handleWebviewBlur,!1),this.body.hidden=!1,this.popup.active=!0,this.popup.reposition(),this.emit("gl-popover-after-show")}else document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),this.emit("gl-popover-hide"),this.closeWatcher?.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),this.popup.active=!1,this.body.hidden=!0,this.emit("gl-popover-after-hide")}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,pe(this,"gl-popover-after-show")}async hide(){if(this.open)return this.open=!1,pe(this,"gl-popover-after-hide")}render(){return Dt`<sl-popup
		...
		</sl-popup>`}};Un.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},Un.styles=Qe`
		:host {
			--hide-delay: 0ms;
			--show-delay: 500ms;
	...
	`,Wn([Gt("#popover")],Un.prototype,"body",2),Wn([Gt("sl-popup")],Un.prototype,"popup",2),Wn([Vt({reflect:!0})],Un.prototype,"placement",2),Wn([Vt({type:Object})],Un.prototype,"anchor",2),Wn([Vt({reflect:!0,type:Boolean})],Un.prototype,"disabled",2),Wn([Vt({type:Number})],Un.prototype,"distance",2),Wn([Vt({reflect:!0,type:Boolean})],Un.prototype,"open",2),Wn([Vt({reflect:!0,type:Boolean})],Un.prototype,"arrow",2),Wn([Vt({type:Number})],Un.prototype,"skidding",2),Wn([Vt()],Un.prototype,"trigger",2),Wn([Vt({type:Boolean})],Un.prototype,"hoist",2),Wn([Mn("open",{afterFirstUpdate:!0})],Un.prototype,"handleOpenChange",1),Wn([Mn(["distance","hoist","placement","skidding"])],Un.prototype,"handleOptionsChange",1),Wn([Mn("disabled")],Un.prototype,"handleDisabledChange",1),Un=Wn([Ut("gl-popover")],Un);var Hn=Object.defineProperty,Nn=Object.getOwnPropertyDescriptor,Vn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?Nn(t,o):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&Hn(t,o,s),s};let jn=class extends lit_element_r{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){return null==this.subscription?0:x(this.subscription,"days")??0}get state(){return this.subscription?.state}render(){return Dt`
		...
		>`;return this.state===a.Paid?Dt`<div class="popup-header">${e}</div>`:this.cloud?this.preview?Dt`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires a paid plan for use on privately-hosted repos</span>
					...
					<gl-tooltip hoist content="Show Account view">
						<a href="${Gn(vn.ShowAccountView,void 0)}"
					...
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Gn(vn.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${Gn(vn.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Gn(vn.PlusReactivateProTrial,this.source)}"
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${Gn(vn.PlusSignUp,this.source)}"
				>Start ${7}-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${Gn(vn.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){const t=wn(this.state,"badge");return Dt`<div class="actions">
			${e??Lt}
			<gl-button
				appearance="primary"
				density="tight"
				href="${Gn(vn.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
			${this.renderPromo(t)}
		</div>`}renderPromo(e){return Dt`<gl-promo .promo=${e}></gl-promo>`}};function Gn(e,t){return`command:${e}${t?`?${encodeURIComponent(JSON.stringify(t))}`:""}`}jn.styles=[ni,ri,Qe`
			:host {
				/* position: relative; */
				display: inline-block;
