...
![Format a file on save. A formatter must be available, the file must not be saved after delay, and the editor must not be shutting down.](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/format-on-save.png)
...
![Enable RuboCop via the workspace's Gemfile or else fall back on a global installation unless a Gemfile is present and its bundle does not include rubocop](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/mode.png)
...
![Autocorrect](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/autocorrect.png)
...
![SafeAutocorrect](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/safe-autocorrect.png)
...
![LintMode](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/lint-mode.png)
...
![LayoutMode](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/layout-mode.png)
...
![Command Path](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/command-path.png)
...
![YJIT Enabled](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/yjit-enabled.png)
...
![Workspace scope](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/workspace.png)
...
![Autocorrect command](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/autocorrect-command.png)
...
![Keybinding](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/keybind.png)
...
![Autocorrect all command](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/autocorrect-all-command.png)
...
![Status: no issues](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/status-ok.png)

When the file contains a low-severity formatting issue:

![Status: info](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/status-info.png)

When the file contains a normal linter error:

![Status: info](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/status-warn.png)

When the file fails to parse at all:

![Status: parse failure](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/status-parse-fail.png)

Clicking the status bar item will open the problems tab:

![Problems tab](https://github.com/rubocop/vscode-rubocop/raw/HEAD/docs/problems.png)
